...
3.  Click on **Design** to navigate to the Design perspective.
    ![](../../images/business_automation/order_management/bc-design-empty.png)
...
![](../../images/business_automation/order_management/create-order-management-project.png)
...
1. In your project, click on the *Add Asset* button in the middle of the screen.
   ![](../../images/business_automation/order_management/add-asset-button.png)

2. In the drop-down menu in the upper-left corner, select `Model`. Click on the *Data Object*
   tile.
   ![](../../images/business_automation/order_management/new-data-object.png) 

3. Give the *Data Object* the name `OrderInfo`. Leave the package set to default.
      ![](../../images/business_automation/order_management/new-data-object-order-info.png) 
...
8. Give it the name `SupplierInfo`
   ![](../../images/business_automation/order_management/new-data-object-supplier-info.png)
...
8. We’re done creating our data model.
    ![](../../images/business_automation/order_management/data-model-created.png)
...
With the domain model defined, we can now sketch out the main flow of the process, the actors, the user task nodes and the required automation decisions.
   ![](../../images/business_automation/order_management/order-management-process.png)
...
3. Expand the *Process Data* section and add the following 3 *Process Variables* by clicking on the *+* sign.
   ...
   ![](../../images/business_automation/order_management/process-variables.png) 
   ...
   ![](../../images/business_automation/order_management/three-swimlanes.png)
   ...
   ![](../../images/business_automation/order_management/prepare-offer-node.png)
...
![](../../images/business_automation/order_management/auto-approval-rules-node.png)
...
![](../../images/business_automation/order_management/xor-gateway-auto-approve-order.png)
...
![](../../images/business_automation/order_management/approve-node.png)



11. Create an **X-OR Gateway**/**Exclusive Gateway** in the `Manager` swimlane, after the `Approve` node and connect it to that node.

![](../../images/business_automation/order_management/xor-gateway-approve.png)
...
![](../../images/business_automation/order_management/xor-gateway-approved.png)
...
![](../../images/business_automation/order_management/place-order-in-erp-node.png)
...
![](../../images/business_automation/order_management/approved-end-event.png)



14. Create an **End Event** node in the `Purchase` swimlane and connect it to the **X-OR Gateway**. Name it `Rejected`.

![](../../images/business_automation/order_management/rejected-end-event.png)
...
![](../../images/business_automation/order_management/sequence-flow-approved-condition.png)



16. On the **Gateway** before the `Approve node`, set the **Default Route** property to `Approve`.

![](../../images/business_automation/order_management/xor-gateway-default-route-approve.png)
...
![](../../images/business_automation/order_management/sequence-flow-manager-approval-condition.png)

18. On the **X/OR Gateway** after the `Approval` node , set the **Default Route** to `Rejected`.

![](../../images/business_automation/order_management/xor-gateway-default-route-rejected.png)

19. Save the process definition.

![](../../images/business_automation/order_management/completed-process.png)
...
2. In the next screen, set the drop-down filter to **Decision**. Select the **DMN** asset. Give it the name `order-approval`.
   ...
   ![](../../images/business_automation/order_management/add-asset-dmn-order-approval.png)
   ...
   ![](../../images/business_automation/order_management/dmn-import-data-object.png) 
   ...
   ![](../../images/business_automation/order_management/dmn-data-type-urgency.png) 

   6. Click on the *Add Constraints* button, select `Enumeration` as the *constraint type*, and set the values  low` and `high`.

   ![](../../images/business_automation/order_management/dmn-data-type-urgency-enumeration.png) 

   

   7. Click on the blue checkmark button to save the type.

   ![](../../images/business_automation/order_management/dmn-datatype-save.png) 
   ...
   ![](../../images/business_automation/order_management/dmn-input-nodes.png) 
   ...
   ![](../../images/business_automation/order_management/dmn-orderinfo-datatype.png) 
   ...
   ![](../../images/business_automation/order_management/dmn-bkm-price-tolerance-edit.png)

   ![](../../images/business_automation/order_management/dmn-bkm-price-tolerance-feel-function.png) 
   ...
   ![](../../images/business_automation/order_management/dmn-bkm-price-tolerance-feel-function-parameter.png) 
   ...
   ![](../../images/business_automation/order_management/dmn-bkm-price-tolerance-decision-table.png) 
   ...
   ![](../../images/business_automation/order_management/dmn-bkm-price-tolerance-dtable-input-clause.png) 

   15. Set the *output clause* data type to `number`. Leave the name empty.

   ![](../../images/business_automation/order_management/dmn-bkm-price-tolerance-dtable-output-clause.png) 

   16. Click on the `Price Tolerance` cell (top cell of the table), and set the data type to `number`.

   ![](../../images/business_automation/order_management/dmn-bkm-price-tolerance-data-type.png) 

   17. Implement the rest of the decision table as shown below. And save the DMN model.

   ![](../../images/business_automation/order_management/dmn-bkm-price-tolerance-dtable-complete.png) 
   ...
   ![](../../images/business_automation/order_management/dmn-complete.png) 

   

   19. Select the `Approve` decision node and click on the edit button.

   ![](../../images/business_automation/order_management/dmn-decision-node-approve-edit.png)

   20. Click on \_Select Expression, and set the logic type to `Literal Expression`.
       ![](../../images/business_automation/order_management/dmn-decision-node-approve-literal-expression-type.png)
   ...
   ![](../../images/business_automation/order_management/dmn-decision-node-aprove-literal-expression.png)

   

   22. Click on the `Approve` cell (top cell of the table), and set the data type to `boolean`.

   ![](../../images/business_automation/order_management/dmn-decision-node-approve-type.png) 
   ...
   ![](../../images/business_automation/order_management/decision-auto-approve-order-data-io.png) 
...
Field](../../images/business_automation/order_management/item-name-ordermanagement-order-field.png)

   * Radio Group:

![Urgency OrderManagement-Order
Field](../../images/business_automation/order_management/urgency-ordermanagement-order-field.png)

   * Decimal Box:

![Target Price OrderManagement-Order
Field](../../images/business_automation/order_management/target-price-order-management-order-field.png)

6. Save the form and create another new form for our `supplierInfo`. Use the following details.

![](../../images/business_automation/order_management/create-order-management-supplierinfo-form.png).
...
![OrderManagement
SupplierInfo](../../images/business_automation/order_management/OrderManagement-SupplierInfo-form.png) 

8. To create this form, drag the `user` field onto the canvas and configure it as follows.

![User OrderManagement-SupplierInfo
Field](../../images/business_automation/order_management/user-ordermanagement-supplierinfo-field.png)
...
Select](../../images/business_automation/order_management/ordermanagement-order-subform-select.png) 11. Drag the `supplierInfo` process variable ontoo the canvas. In the pop-up form, set the `OrderManagement-SupplierInfo` form we just created as the **Nested Form**:

![Order Management SupplierInfo Subform
Select](../../images/business_automation/order_management/ordermanagement-supplierinfo-subform-select.png)
...
1.  Create a new form. Provide the following details:
    ...
    Form](../../images/business_automation/order_management/create-prepare-offer-task-form.png) 2.  Our aim is to create a form that looks as such:
...
OrderInfo](../../images/business_automation/order_management/PrepareOffer-OrderInfo-form.png)

**PrepareOffer-SupplierInfo** ![PrepareOffer
SupplierInfo](../../images/business_automation/order_management/PrepareOffer-SupplierInfo-form.png)
...
SupplierInfo](../../images/business_automation/order_management/Approve-SupplierInfo-form.png)

**Approve-OrderInfo** ![Approve OrderInfo
Form](../../images/business_automation/order_management/Approve-OrderInfo-form.png)
...
2.  In the form that opens, pick the **Huawei P10 Phone** as the item and set the urgency to **low**. Set the target price to **700** and set the supplier name to the name of your own Business Central user (e.g. `pamAmdmin`). Click on **Submit**.
    ...
    ![](../../images/business_automation/order_management/start-process-form.png) 3. In the process instance details screen that opens, click on the **Diagram** tab to open the process instance diagram, which shows the current state of the process.
...
6. Select a random delivery date. Set the best offer to **900**. Click on **Complete**.![Prepare Offer Complete
   Task](../../images/business_automation/order_management/prepare-offer-complete-task.png)
...
Accepted](../../images/business_automation/order_management/process-instance-completed-order-accepted.png)
...
5. Although we have re-activated the `Prepare Offer` node, we have not yet de-activated the `Approve` task. Click on the active `Approve` task and expand the **Node Instances** section in the **Node Actions** panel. Click on the kebab icon of the active `Approve` instance and click on **Cancel**:
   ...
   ![](../../images/business_automation/order_management/approve-node-cancel.png) 6. Open the **Task Inbox**. Observe that the `Approve` **User Task** is gone and that we have a new `Prepare Offer` task. 
   ...
   * Open the `Prepare Offer` task, set the price to a price which will trigger the rules to automatically
   ...
   ![Process Instance Completed Order
   Accepted](../../images/business_automation/order_management/corrected-process-instance-completed.png)
...
3.  Locate the **POST** operation for the resource `/server/containers/{containerId}/processes/{processId}/instances`. This is the RESTful operation with which we can start a new process instance. Expand the operation:
    ...
    ![](../../images/business_automation/order_management/start-process-instance-rest-operation.png)
...
5. Set the **Response content type** to `application/json`.
   ...
   -   Set the **body** to:
       ...
       Request](../../images/business_automation/order_management/send-new-process-instance-rest-request.png)
...
![Get Task Instances Potential
    Owner](../../images/business_automation/order_management/get-task-instances-potential-owner.png)
